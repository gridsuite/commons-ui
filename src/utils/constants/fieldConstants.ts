...
export enum FieldConstants {
    ...
    TEMPORARY_LIMITS_MODIFICATION_TYPE = 'temporaryLimitsModificationType',
    OLGS_MODIFICATION_TYPE = 'operationalLimitsGroupsModificationType',
    AMOUNT_TEMPORARY_LIMITS = 'amountTemporaryLimits',
    LIMIT_GROUP_NAME = 'limitGroupName',
    ...
    ROW_ID = 'rowId',
    SHUNT_COMPENSATOR_ID = 'shuntCompensatorId',
    SHUNT_COMPENSATOR_NAME = 'shuntCompensatorName',
    PREVIOUS_SHUNT_COMPENSATOR_SELECTED = 'previousConnectedToHvdc',
