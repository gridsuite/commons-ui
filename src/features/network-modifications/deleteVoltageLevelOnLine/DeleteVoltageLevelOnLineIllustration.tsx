...
import { GenericIllustrationNetworkModification } from '../common';
import DeleteVoltageLevelOnLine from '../../../images/network-modifications/illustrations/delete-voltage-level-on-line.svg?react';
...
export const DeleteVoltageLevelOnLineIllustration: FunctionComponent = function DeleteVoltageLevelOnLineIllustration() {
    return (
        <GenericIllustrationNetworkModification
            svgComponent={DeleteVoltageLevelOnLine}
