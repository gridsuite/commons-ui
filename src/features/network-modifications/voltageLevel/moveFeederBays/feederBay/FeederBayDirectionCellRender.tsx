...
const DIRECTION_ICONS: Record<string, ReactNode> = {
    [CONNECTION_DIRECTIONS_VALUES.TOP.id]: <ArrowUpward />,
    [CONNECTION_DIRECTIONS_VALUES.BOTTOM.id]: <ArrowDownward />,
};
...
export function FeederBayDirectionCellRenderer({ name, disabled }: Readonly<FeederBayDirectionCellRendererProps>) {
