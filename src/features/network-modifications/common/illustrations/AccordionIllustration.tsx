...
export const AccordionIllustration: FunctionComponent<PropsWithChildren<AccordionIllustrationProps>> =
    function AccordionIllustration(props) {
        const [mouseHover, setMouseHover] = useState(false);
        const { state, onClick, children } = props;
        return (
            <Accordion
                sx={styles.accordion}
                expanded={state}
