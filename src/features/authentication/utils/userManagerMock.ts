...
class Events {
    public userLoadedCallbacks: UserLoadedCallback[] = [];
...
export class UserManagerMock {
    ...
    private static readonly user: Readonly<User> = Object.freeze(
        new User({
            profile: {
                name: 'John Doe',
            ...
            access_token:
                ...
                'DdSUVlfY3FjSDJoVHpEdllZTmotQ3hONXA0IiwidGlkIjoiNzUwMmRhZDUtZDY0Yy00NmM3LTlkNDctYjE2ZjU4MGZjZmE5IiwidW5pcXVlX25hbWUiOiJsaXZlLmNvbSNjaGFtc2VkZGluZS5iZW5oYW1lZEBlbnNpLXVtYS50biI' +
