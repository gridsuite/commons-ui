...
import {
    ...
    DataType,
    OperatorType,
} from '../../../../../components/composite/filter/expert/expertFilter.type';
import { ExpertFilter } from '../../../../../components/composite/filter/filter.type';
import { FilterType } from '../../../../../components/composite/filter/constants/FilterConstants';
...
export const buildExpertRules = (
    ...
    Object.entries(ids ?? {}).forEach(([eqType, values]) => {
