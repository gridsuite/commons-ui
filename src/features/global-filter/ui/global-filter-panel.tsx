...
import { GlobalFilterType } from '../types/global-filter.type';
import { OverflowableText, OverflowableChip } from '../../../components';
...
function RenderOption(props: RenderOptionProps) {
...
export function GlobalFilterPanel({
    ...
    const [filterGroupSelected, setFilterGroupSelected] = useState<string>(GlobalFilterType.VOLTAGE_LEVEL);
            ...
            const filteredOptions = options
                ...
                .filter((option: GlobalFilter) => {
                    const labelToMatch: string =
                        option.filterType === GlobalFilterType.COUNTRY
                            ? translateCountryCode(option.label)
                            : option.label;
                ...
                .filter((option: GlobalFilter) => {
                    ...
                    if (
                        filterGroupSelected === GlobalFilterType.GENERIC_FILTER &&
            ...
            globalFilterOptions
                ...
                .filter(
                    (filter) =>
                        ...
                        (genericFiltersStrictMode && filter.filterType === GlobalFilterType.GENERIC_FILTER
        ...
        <>
            <div ref={autocompleteRef}>
                <Autocomplete
                    ...
                    filterOptions={(autocompleteOptions: GlobalFilter[], state: FilterOptionsState<GlobalFilter>) =>
