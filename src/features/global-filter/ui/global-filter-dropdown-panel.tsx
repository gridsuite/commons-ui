...
import { GlobalFilterType, isCriteriaFilterType } from '../types/global-filter.type';
import type { GlobalFilterProps } from './global-filter-panel';
import { TreeViewFinderNodeProps, DirectoryItemSelector } from '../../../components';
import { EquipmentType, mergeSx, ElementType } from '../../../utils';
...
function GlobalFilterDropdownPanel({
    ...
    const standardCategories: string[] = useMemo(() => {
        const filteredCategories = filterCategories
            ...
            .filter((category) => category !== GlobalFilterType.SUBSTATION_PROPERTY)
            .filter((category) => {
