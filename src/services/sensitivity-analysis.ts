...
import { enrichSensitivityAnalysisParameters, mapSensitivityAnalysisParameters } from './sensitivity-analysis.utils';
...
export function setSensitivityAnalysisParameters(
    studyUuid: UUID | null,
    newParamsInfos: SensitivityAnalysisParametersInfosEnriched | null
) {
