...
export const parametersFr = {
    ...
    ShortCircuitIccMaterialAlphaTooltip: 'Coefficient de pente de la caractéristique Icc en p.u./p.u.',
    ShortCircuitIccMaterialUsmin: 'Usmin (p.u.)',
    ShortCircuitIccMaterialUsminTooltip: 'Tension minimale pour le calcul de Icc',
    ShortCircuitIccMaterialUsmax: 'Usmax (p.u.)',
    ShortCircuitIccMaterialUsmaxTooltip: 'Tension maximale pour le calcul de Icc',
    ShortCircuitIccMaterialU0: 'U0 (p.u.)',
