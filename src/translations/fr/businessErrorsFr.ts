...
export const businessErrorsFr = {
    ...
    'computation.resultNotFound': "Erreur lors de la récupération des résultats.",
    'computation.parametersNotFound': "Erreur lors de la récupération des paramètres.",
    ...
    'shortcircuit.busOutOfVoltage': "Bus sélectionné introuvable.",
    'shortcircuit.missingExtensionData': "Données de l'extension cour-circuit manquantes.",
