...
export const specificParametersFr = {
    // Open LoadFlow
    slackBusSelectionMode: 'Mode de sélection du noeud bilan',
    slackBusesIds: 'Identifiants des noeud bilan',
    ...
    slackBusPMaxMismatch: 'Déséquilibre maximal au noeud bilan',
    ...
    shuntVoltageControlMode: 'Mode de contrôle de tension des moyen de compensation statique',
    minPlausibleTargetVoltage: 'Tension de consigne minimale plausible',
    maxPlausibleTargetVoltage: 'Tension consigne maximale plausible',
    ...
    maxSlackBusCount: 'Nombre maximal de noeud bilan',
    ...
    reactiveLimitsMaxPqPvSwitch: 'Nombre maximal de changementsPV-PQ',
    ...
    slackBusCountryFilter: 'Filtre pays pour les noeud bilan',
    ...
    minNominalVoltageTargetVoltageCheck: 'Tension nominale minimale pour contrôle des consignes',
