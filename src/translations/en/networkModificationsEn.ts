...
export const networkModificationsEn = {
    ...
    HvdcLineTab: 'HVDC Line',
    ConverterStation1Tab: 'Converter station 1',
    ConverterStation2Tab: 'Converter station 2',
    ...
    TapPositionMustBeBetweenLowAndHighTapPositionValue:
        'Tap position must be between Low tap position and High tap position',
